...
<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        // Save employee income record to database
        $sql1 = "INSERT INTO incometbl (employee_no, income_date, basic_rate_hour, basic_num_hrs, basic_income, hono_rate_hour, hono_num_hrs, hono_income, other_rate_hour, other_num_hrs, other_income, gross_income, net_income)
    VALUES ('$employee_number', '$pay_date', '$basic_rate_hour', '$basic_num_hours_cutoff', '$basic_income_cutoff', '$hono_rate_hour', '$hono_num_hours_cutoff', '$hono_income_cutoff', '$other_rate_hour', '$other_num_hours_cutoff', '$other_income_cutoff', '$gross_income', '$net_income')";
        ...
        // Save employee deduction record to database
    ...
    VALUES ('$employee_number', '$pay_date', '$sss_contri', '$philH_contri', '$pagibig_contri', '$tax_contri', '$sss_loan', '$pagibig_loan', '$fs_deposit', '$fs_loan', '$salary_loan', '$other_loans', '$total_deduction')";
