...
<header style="text-align:center">
 <h1 style="font-style:bold; font-family:cursive; color:blue">EMPLOYEE SALARY COMPUTATION DETAILS</h1>
 <?php
...
name="employee_number" value="<?php echo $employee_number; ?>"/>
 ...
 <br>
 <br>
 <span style="margin-left:-50px" ><font size="5px" color="blue">
...
Pagibig Contribution</font></span>
 ...
 <br>
 <br>
 <span style="margin-left:-85px"><font size="5px" color="blue">
...
<span style="margin-left:-4px; padding-top:3px">Employer Philhealth Contribution:</span>
 ...
 <input type="text" name="gross_income" value="<?php echo $gross_income; ?>"
disabled />
 <br>
