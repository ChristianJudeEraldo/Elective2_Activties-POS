...
<body>
    ...
    <div class="container pag">
        <h1 class="text-center" style="padding-top:10px; padding-bottom:10px; font-family: Algerian; font-weight:bold;">
            Jude's Food Ordering Application
        </h1>

        <div class="pic_group">
            <div class="pic_option">
                <div><img src="images/cake2.jfif" alt="Cinque Terre"></div>
                <input type="checkbox" id="checkbox1" name="checkbox1">
                <label for="checkbox1">Barkada Meal 1</label>
            </div>

            <div class="pic_option">
                <div><img src="images/cake3.jfif" alt="Cinque Terre"></div>
                <input type="checkbox" id="checkbox2" name="checkbox2">
                <label for="checkbox2">Family Meal A</label>
            </div>

            <div class="pic_option">
                <div><img src="images/cake4.jfif" alt="Cinque Terre"></div>
                <input type="checkbox" id="checkbox3" name="checkbox3">
                <label for="checkbox3">Chicken Value Meal 1</label>
            </div>

            <div class="pic_option">
                <div><img src="images/cake5.jfif" alt="Cinque Terre"></div>
                <input type="checkbox" id="checkbox4" name="checkbox4">
                <label for="checkbox4">Family Drink Pack B</label>
            </div>

            <div class="pic_option">
                <div><img src="images/cake7.png" alt="Cinque Terre"></div>
        ...
        <div style="width:100%; text-align:left;">
            <div style="width:40%; float:left;">
                ...
                <div style="width:100%; text-align:left; padding-left:100px;">
                    <h6 class="text-left" style="padding-top:10px; font-weight:bold;">Food Bundle A:</h6>
                    <div class="bundle_checkbox">
                        <input type="checkbox" name="deli_chicken" id="deli_chicken" disabled>
                        10 pcs. Delicious Fried Chicken
                    </div>
                </div>

                <div style="width:100%; text-align:left; padding-left:100px;">
                    <h6 class="text-left" style="padding-top:10px; font-weight:bold;">Food Bundle B:</h6>
                    <div class="bundle_checkbox">
                        <input type="checkbox" name="halo_halo" id="halo_halo" disabled>
            ...
            <div style="width:40%; float:left;">
                ...
                <div style="width:100%; text-align:left; padding-left:10px; margin-bottom:50px;">
                    ...
                    <div class="input_box">
                        ...
                        <input type="text" name="amount_to_pay" id="amount_to_pay" disabled>
                    </div>

                    <div class="input_box">
                        <span>Cash From Customer:</span>
                        <input type="text" name="amount_from_customer" id="amount_from_customer">
                    </div>
    ...
    <div class="container" id="process_button" style="margin-top:43px;">
        <button type="submit" id="btn_calculate_bills" name="calculate_bills" class="btn btn-primary btn_process">CALCULATE BILLS</button>
